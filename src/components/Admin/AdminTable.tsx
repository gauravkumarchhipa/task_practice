              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                ...
                <tbody>
                  {profile?.map((data: any) => (
                    <tr
                      className=" border-b bg-gray-400 border-gray-700"
                      key={data?.id}
                    >
                      <th
                        scope="row"
                      ...
                      <td className="px-6 py-4 text-gray-700">{data?.age}</td>
                      ...
                      <td className="px-6 py-4 text-gray-700 flex">
                        <div
                          onClick={() => {
                            setViewModalOpen(true);
                            setVieModalData(data);
                          }}
                        >
                          <RemoveRedEyeIcon />
                        </div>
